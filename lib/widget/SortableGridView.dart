...
//    _scrollController?.dispose();
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
        itemBuilder: widget.canDraggle ? _buildDraggable : widget.itemBuilder,
...
//      controller: _scrollController,
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: widget.childAspectRatio, //i
          crossAxisCount: widget.crossAxisCount, //列数// tem宽高比
        ));
  }
        ...
        return LongPressDraggable(
          ...
          child: DragTarget<int>(
            ...
            onAccept: (int fromIndex) {
              widget.canAccept(fromIndex, index);
            },
            //绘制widget
          ...
          childWhenDragging: Container(
            child: SizedBox(
              child: _showItemWhenCovered
                  ? widget.itemBuilder(context, _willAcceptIndex)
                  : null,
            ),
          ),
        );
