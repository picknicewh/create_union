    ...
    switch (nip) {
      case BubbleNip.leftTop:
        ...
        if (nipRadius == 0) {
          ...
          path.lineTo(_nipPX, nipOffset + _nipPY + nipHeight / 2);
          path.arcToPoint(Offset(_nipCX, nipOffset + nipHeight / 2),
      ...
      case BubbleNip.rightTop:
        ...
        if (nipRadius == 0) {
          ...
          path2.lineTo(size.width - _nipPX, nipOffset + _nipPY + nipHeight / 2);
          path2.arcToPoint(
              Offset(size.width - _nipCX, nipOffset + nipHeight / 2),
              radius: Radius.circular(nipRadius),
              clockwise: false);
        }
        path2.close();
